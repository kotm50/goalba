...
function Scrape() {
  ...
  const [scrapeList, setScrapeList] = useState<JobSiteList[]>([]); // 스크랩 목록
  const [scrapeTotalPage, setScrapeTotalPage] = useState<number>(); // 스크랩 총 페이지
  const [currentScrapePage, setCurrentScrapePage] = useState<number>(1); // 스크랩 현재 페이지
  ...
  return (
    <div className="flex w-full flex-col">
      {isMobileScreen ? <AppBar title={"스크랩"} /> : <MainHeaderPC />}
      ...
      <div className="flex w-full flex-col items-center px-5 pt-[30px] pc:mx-auto pc:max-w-[1240px] pc:pt-3">
        ...
        <div className="hidden w-full flex-col gap-2 pb-[11px] pc:flex">
          <h2 className="text-[32px] font-semibold">스크랩</h2>
          <div className="flex flex-col">
            <p className="text-base leading-[30px] text-[#666666]">
              • 채용정보 상하단의 별 모양 버튼을 누르면 공고가 저장됩니다
            </p>
            <p className="text-base leading-[30px] text-[#666666]">
